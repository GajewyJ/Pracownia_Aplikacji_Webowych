...
app.post('/data', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        client.connect();
        const result = yield db.collection("dataStorage").insertOne(message);
...
app.get('/data', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        client.connect();
        const result = yield db.collection("dataStorage").find().toArray();
        res.json(result);
    }
    catch (e) {
        console.log(e);
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        app.post(`/cars`, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { brand, model, productionYear, registrationNumber, dealer } = req.body;
            const result = yield prisma.cars.create({
                data: {
                    brand,
                    model,
                    productionYear,
        ...
        app.delete(`/cars/:id`, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
        ...
        app.post(`/adresses`, (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        app.put('/adresses/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const { adress } = req.body;
        ...
        app.delete(`/adresses/:id`, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
        ...
        app.post(`/dealers`, (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        app.put('/dealers/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const { name, adress } = req.body;
        ...
        app.delete(`/dealers/:id`, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
        ...
        app.post(`/clients`, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { name } = req.body;
        ...
        app.put('/clients/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const { name } = req.body;
        ...
        app.delete(`/clients/:id`, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
        ...
        app.post(`/sales`, (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        app.put('/sales/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const { client, price, dealer } = req.body;
        ...
        app.delete(`/sales/:id`, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
        ...
        app.post(`/testdrives`, (req, res) => __awaiter(this, void 0, void 0, function* () {
        ...
        app.put('/testdrives/:id', (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const { clientsId, carsId, drivesDate } = req.body;
        ...
        app.delete(`/testdrives/:id`, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
